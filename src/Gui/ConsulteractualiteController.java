...
public class ConsulteractualiteController implements Initializable {
  ...
  java.sql.Date d = java.sql.Date.valueOf(date_ac.getValue());
                Actualite p = new Actualite(tftitre.getText(), d, tfdes.getText(), tfimg.getText());
                as.insertPst(p);
        ...
        delete.setOnAction((ActionEvent e) -> {
            ...
            update.setOnAction((ActionEvent e) -> {
               ...
               /* } else if (imageUpload == null) {
                    ...
                    Actualite a = new Actualite(Integer.parseInt(tfid.getText()), tftitre.getText(), d, tfdes.getText(), tfimg.getText());
    ...
    private void sponsoring(ActionEvent event) throws IOException {
      Parent tableViewParent = FXMLLoader.load(getClass().getResource("consultersponsoring.fxml"));
            Scene tableViewScene = new Scene(tableViewParent);
